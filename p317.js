...
// Planteamiento: Agrupa objetos en un nuevo array según un rango de edades.
...
// { '0-20': [{ nombre: 'Juan', edad: 20 }],
// '21-30': [{ nombre: 'Ana', edad: 22 }, { nombre: 'Carlos', edad: 25 }],
//  '31+': [{ nombre: 'Luisa', edad: 30 }] }
